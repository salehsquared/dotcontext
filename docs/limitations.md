...
**Mitigation:** Use `validate --strict` to catch drift. Cross-reference with actual code for critical decisions. Static mode (`--no-llm`) avoids narrative fields entirely — everything it produces is machine-derived.
